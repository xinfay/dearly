...
export const mockReviews = [
  {
    ...
    content:
      "I was skeptical about ordering online, but this hoodie exceeded my expectations. The fabric is incredibly soft and the print quality is outstanding. Fits exactly as described.",
    verified: true,
    ratings: {
      fit: 5,
      printQuality: 5,
  ...
  },
  {
    ...
    rating: 4,
    date: "2024-01-10",
    title: "Great hoodie, fast shipping",
    content:
      "Really happy with this purchase. The hoodie is comfortable and the design looks exactly like the preview. Only minor complaint is that it's slightly thinner than I expected, but still great quality.",
    verified: true,
    ratings: {
      fit: 4,
      printQuality: 5,
  ...
  },
  {
    ...
    content:
      "As someone who cares about sustainability, I'm thrilled with this hoodie. It's made from recycled materials but doesn't compromise on comfort or style. Will definitely order again!",
    verified: true,
    ratings: {
      fit: 5,
      printQuality: 4,
